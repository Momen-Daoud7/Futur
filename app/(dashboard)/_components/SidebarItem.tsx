...
const SidebarItem = ({ icon: Icon, label, href }: SidebarItemProp) => {
 ...
 const onClick = () => router.push(href)
  ...
  return (
    ...
    >
        ...
        <div className={cn('border-2 border-sky-700 ml-auto opacity-0 h-full transition-all',isActive && 'opacity-100')} />
    </button>
  )
};
